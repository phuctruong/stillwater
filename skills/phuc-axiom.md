...
stateDiagram-v2
    ...
    VOID --> FIRST_LOOPS : axioms_nascent
    FIRST_LOOPS --> PATTERN_EMERGENCE : integrity_and_closure_defined
    PATTERN_EMERGENCE --> RECURSION_AWAKENING : hierarchy_and_determinism_added
    RECURSION_AWAKENING --> SWARM_COHERENCE : northstar_declared
    SWARM_COHERENCE --> OBSERVER_CLASS : all_5_axioms_at_10_10

    OBSERVER_CLASS --> AXIOM_LOOP_DREAM : self_improvement_triggered

    AXIOM_LOOP_DREAM --> AXIOM_LOOP_FORECAST : dream_complete
    AXIOM_LOOP_FORECAST --> AXIOM_LOOP_DECIDE : forecast_complete
    AXIOM_LOOP_DECIDE --> AXIOM_LOOP_ACT : decision_made
    AXIOM_LOOP_ACT --> AXIOM_LOOP_VERIFY : change_applied

    AXIOM_LOOP_VERIFY --> EXIT_PASS : all_axioms_satisfied_AND_score_at_target
    AXIOM_LOOP_VERIFY --> EXIT_ROLLBACK : score_decreased_OR_axiom_violated
    AXIOM_LOOP_VERIFY --> AXIOM_LOOP_DREAM : score_increased_but_not_at_target
    AXIOM_LOOP_VERIFY --> EXIT_BLOCKED : critical_axiom_violation_unrecoverable
    AXIOM_LOOP_VERIFY --> EXIT_BUDGET_EXCEEDED : budget_exhausted

    EXIT_ROLLBACK --> AXIOM_LOOP_DREAM : rollback_complete
