...
- Add a `cli/papers/` documentation spine for Stillwater CLI Software 5.0.
...
4. `pytest -q cli/tests/test_cli_kernel_config.py` passes with external `papers_dirs`.

## Artifacts

- `cli/papers/*.md`
- `cli/notebooks/HOW-TO-SOFTWARE-5.0-PAPERS.ipynb`
- test receipts from `cli/tests/*`
