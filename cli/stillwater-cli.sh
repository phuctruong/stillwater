...
Usage:
  ./cli/stillwater-cli.sh                      # interactive twin chat (TTY)
  ./cli/stillwater-cli.sh <stillwater-subcommand> [args...]
...
Examples:
  ./cli/stillwater-cli.sh twin "explain twin orchestration"
  ./cli/stillwater-cli.sh twin --interactive
  STILLWATER_EXTENSION_ROOT=cli/extensions ./cli/stillwater-cli.sh twin "/kernel"
  ./cli/stillwater-cli.sh llm status
  ./cli/stillwater-cli.sh skills list
  ./cli/stillwater-cli.sh recipe list
  ./cli/stillwater-cli.sh books list
  ./cli/stillwater-cli.sh papers list
  ./cli/stillwater-cli.sh cleanup scan --json
  ./cli/stillwater-cli.sh init agi-cli my-agent --dir artifacts/scaffolds --identity-stack
  ./cli/stillwater-cli.sh stack run --profile offline
  ./cli/stillwater-cli.sh qa-notebooks
  ./cli/stillwater-cli.sh qa-secret-sauce
  ./cli/stillwater-cli.sh qa-imo
  ./cli/stillwater-cli.sh qa-imo-phuc
  ...
  ./cli/stillwater-cli.sh imo-history autolearn --from-year 2020 --to-year 2024 --fetch-missing --required-rung 65537 --max-iterations 3 --oracles-file cli/tests/math/imo_history_oracles.json
...
run_qa_notebooks() {
  ...
  for nb in cli/notebooks/HOW-TO-*.ipynb; do
    local out_name
...
run_qa_imo() {
  ...
  local cases_file="${STILLWATER_IMO_CASES_FILE:-cli/tests/math/imo_qa_cases.json}"
...
run_qa_imo_history() {
  local history_cfg="${STILLWATER_IMO_HISTORY_CONFIG_FILE:-cli/tests/math/imo_history_defaults.json}"
  local oracles_file="${STILLWATER_IMO_HISTORY_ORACLES_FILE:-cli/tests/math/imo_history_oracles.json}"
...
run_qa_math_universal() {
  local config_file="${STILLWATER_MATH_UNIVERSAL_CONFIG_FILE:-cli/tests/math/universal_math_gate.json}"
  local model="${STILLWATER_IMO_MODEL:-llama3.1:8b}"
  local timeout="${STILLWATER_IMO_TIMEOUT:-45}"
