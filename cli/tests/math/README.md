...
3. Run:
   ...
   - `./cli/stillwater-cli.sh imo-history bench --required-rung 65537 --from-year 2024 --to-year 2024 --max-problems 6`
   - `./cli/stillwater-cli.sh imo-history bench --required-rung 65537 --oracles-file cli/tests/math/imo_history_oracles.json --from-year 2024 --to-year 2024 --max-problems 6`
   - `./cli/stillwater-cli.sh imo-history autolearn --required-rung 65537 --from-year 2020 --to-year 2024 --max-iterations 3 --oracles-file cli/tests/math/imo_history_oracles.json`
