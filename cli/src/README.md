...
### ✅ Correct: `cli/src/claude_code_wrapper.py`
...
### ❌ Don't Use: `cli/src/claude_code_wrapper_ollama.py`
...
# NOT:
❌ python3 cli/src/claude_code_wrapper_ollama.py
```
...
| Item | Details |
|------|---------|
| **Correct Wrapper** | `cli/src/claude_code_wrapper.py` |
| **Wrong Wrapper** | `cli/src/claude_code_wrapper_ollama.py` |
| **Start Command** | `python3 cli/src/claude_code_wrapper.py --port 8080 &` |
...
- ✅ Use `cli/src/claude_code_wrapper.py` (not ollama version)
