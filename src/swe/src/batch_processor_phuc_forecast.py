...
class PhucForecastBatchProcessor:
    ...
    def __init__(self, output_dir: Path = None):
        self.output_dir = output_dir or Path("src/swe/results")
    ...
    def decide_phase(self) -> Dict:
        ...
        decisions = {
            "dry_run": os.environ.get("STILLWATER_SWE_DRY_RUN") == "1",
            "batch_size": 10,
        ...
        print(f"[Lane A] Using DRY_RUN: {decisions['dry_run']}")
        ...
        for idx, instance_data in enumerate(instances, 1):
            ...
            try:
                ...
                result = subprocess.run(
                    ['python3', 'src/swe/src/swe_solver_real.py'],
