...
- src/swe/src/swe_solver_real.py (optional; disabled by default — requires `STILLWATER_ENABLE_LEGACY_SOLVERS=1`)

This solver demonstrates the Prime Skills methodology:
- Prime Coder v1.3.0 (Red-Green gates, Core Pattern, Resolution Limits)
...
def main():
    ...
    print("\n✓ Prime Skills:")
    print("  Prime Coder v1.3.0: ACTIVE (Red-Green gates, Core Pattern)")
