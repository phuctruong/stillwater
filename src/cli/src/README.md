...
# Then open and run: HOW-TO-SWE-BENCHMARK.ipynb
```
...
### ✅ Correct: `src/cli/src/claude_code_wrapper.py`
...
### ❌ Don't Use: `src/cli/src/claude_code_wrapper_ollama.py`
...
# NOT:
❌ python3 src/cli/src/claude_code_wrapper_ollama.py
```
...
| Item | Details |
|------|---------|
| **Correct Wrapper** | `src/cli/src/claude_code_wrapper.py` |
| **Wrong Wrapper** | `src/cli/src/claude_code_wrapper_ollama.py` |
| **Start Command** | `python3 src/cli/src/claude_code_wrapper.py --port 8080 &` |
...
- ✅ Use `src/cli/src/claude_code_wrapper.py` (not ollama version)
