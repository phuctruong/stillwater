...
def test_real_default_files_exist_and_load() -> None:
    """Smoke test: jokes.json, wishes.md, and at least one combo file exist and load."""
    ...
    combo = reg.load_data_file("combos/plan-combo.md")
    ...
    assert combo is not None, "data/default/combos/plan-combo.md missing or unreadable"
