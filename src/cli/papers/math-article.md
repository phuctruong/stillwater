...
- `src/cli/papers/08-imo-history-convergence-results.md`
...
- command: `./src/cli/stillwater-cli.sh math-universal --config src/cli/tests/math/universal_math_gate.json --no-strict --json`
