...
- command: `./src/cli/stillwater-cli.sh qa-imo`
...
- command: `./src/cli/stillwater-cli.sh imo-phuc --model llama3.1:8b --required-rung 65537 --json`
...
- command: `./src/cli/stillwater-cli.sh imo-history bench --from-year 2022 --to-year 2022 --max-problems 2 --required-rung 641 --model llama3.1:8b --json`
...
- command:
  - `./src/cli/stillwater-cli.sh imo-history bench --from-year 2022 --to-year 2022 --max-problems 2 --required-rung 65537 --model llama3.1:8b --json`
...
- command:
  - `./src/cli/stillwater-cli.sh imo-history oracle-status --from-year 2022 --to-year 2024 --oracles-file src/cli/tests/math/imo_history_oracles.json --json`
...
### ACT
Implemented in `src/cli/src/stillwater/cli.py`:
...
7. historical oracle targets are externalized (`src/cli/tests/math/imo_history_oracles.json` or `imo-history bench --oracles-file ...`)
...
- `src/cli/papers/math-secret-sauce.md`
