...
flowchart LR
    ...
    subgraph WHY_UNCOPYABLE["Why Token-Revenue Vendors Cannot Implement OAuth3"]
        ...
        WU4["Strategic moat: only OSS\n(Stillwater) can fully implement OAuth3"]
...
- Why token-revenue vendors (OpenAI, Anthropic) cannot implement OAuth3 (strategic moat)
