...
- `/home/phuc/projects/stillwater/skills/prime-qa.md` — full QA skill: state machine, decoupled verification, falsifier requirement, integration probes, evidence schema
