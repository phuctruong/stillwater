...
- `~/projects/stillwater/store/rung_validator.py` — `RungValidator` class, gate logic, `VALID_RUNGS`, `REQUIRED_EVIDENCE_FILES`, `verify_evidence()`, `verify_rung()`, `validate_bundle()`
