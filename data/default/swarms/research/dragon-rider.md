...
5. The kata is complete when the convention is in data/default/magic-words/ and used correctly in a new artifact.
...
- Convention created (LEC) is in data/default/magic-words/ and has ≥3 adoption examples in the wild
