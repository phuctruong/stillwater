...
artifacts:
  ...
  - data/default/diagrams/{project}/02-data-flow.md
  - data/default/diagrams/{project}/03-state-machines.md
  - data/default/diagrams/{project}/04-sequence-diagrams.md
  - data/default/diagrams/{project}/05-class-entity.md
  - data/default/diagrams/{project}/06-user-journey.md
  - data/default/diagrams/{project}/07-deployment.md
  - data/default/diagrams/{project}/08-dependency-graph.md
  - data/default/diagrams/{project}/gap-report.md
---
...
### data/default/diagrams/{project}/NN-{name}.md format
...
OUTPUT_DIR: <absolute path where data/default/diagrams/ directory will be written>
