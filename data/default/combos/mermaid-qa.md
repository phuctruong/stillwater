...
- `data/default/diagrams/{project}/*.md` — individual diagram files (numbered 01-NN)
...
- `data/default/diagrams/{project}/01-system-architecture.md`
- `data/default/diagrams/{project}/02-project-ecosystem.md` (if multi-project)
- `data/default/diagrams/{project}/03-data-flow.md`
- `data/default/diagrams/{project}/NN-deployment.md`
- `data/default/diagrams/{project}/NN-dependencies.md`
...
- `data/default/diagrams/{project}/NN-data-model.md`
- `data/default/diagrams/{project}/NN-auth-flow.md`
- `data/default/diagrams/{project}/NN-session-lifecycle.md`
- `data/default/diagrams/{project}/NN-user-journey.md`
...
- All `data/default/diagrams/{project}/*.md` files (from Node 2 + Node 3)
...
|------|------------|-------|
| Category coverage | All 8 diagram categories represented | `ls data/default/diagrams/{project}/*.md | wc -l >= 8` |
...
| Mermaid validity | All diagrams have valid mermaid code blocks | `grep -c '```mermaid' data/default/diagrams/{project}/*.md` each >= 1 |
