...
- `S5-EVO-API-01` `PROVIDER_TEST_STRICT_MODE` (see `skills/prime-skills-evolution.md`)
- `S5-EVO-API-02` `HEALTH_ENDPOINT_CONTRACT` (see `skills/prime-skills-evolution.md`)
