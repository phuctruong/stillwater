...
- `data/default/diagrams/stillwater/23-service-registry.md` — ServiceDescriptor model and registry flow
- `data/default/diagrams/stillwater/24-service-mesh.md` — Inter-service communication topology
- `data/default/diagrams/stillwater/20-oauth3-flow.md` — OAuth3 token lifecycle (OAuth3 Authority design)
