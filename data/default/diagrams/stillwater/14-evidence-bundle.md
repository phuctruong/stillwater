...
- `/home/phuc/projects/stillwater/src/store/rung_validator.py` — `RungValidator`: all gate logic, `REQUIRED_EVIDENCE_FILES`, `PLAN_REQUIRED_FIELDS`, `TESTS_REQUIRED_FIELDS`, `BEHAVIOR_REQUIRED_SEEDS`, `compute_behavior_hash()`, `verify_evidence()`, `verify_rung()`, `validate_bundle()`
